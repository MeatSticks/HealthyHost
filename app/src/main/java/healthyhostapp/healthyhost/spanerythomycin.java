...
public class spanerythomycin extends AppCompatActivity {
    static private MediaPlayer mediaPlayer;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.spanerythomycin);
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.spanish_anti_erythomycin);
